...
def main():
  fontPath = input("フォントファイル(.ttf .otf)のパスを入力してください\\n例: C:\\Users\\...\\MyFont.ttf\n")
  resourcePackPath = input("生成するリソースパックのディレクトリパスを入力してください\\n例: C:\\Users\\...\\AppData\\Roaming\\.minecraft\\resourcepacks\\MyFontPack\n")
  size = None
  while not size:
    try:
